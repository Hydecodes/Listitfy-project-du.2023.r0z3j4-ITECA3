...
$sql = 'SELECT orders.*, products.title FROM orders JOIN products ON orders.product_id = products.product_id
...
<body>
    ...
    <div class='container'>
      ...
      <h3> R <?php echo ($order['price']); ?></h3>
      <h3> <?php echo ($order['quantity']); ?></h3>
      <h3> <?php echo ($order['time']);?></h3>
      <p> Please allow 3-4 days for instock products to ship</p>
      <p> To view the progress of your order go to home/account/myorders</p>
